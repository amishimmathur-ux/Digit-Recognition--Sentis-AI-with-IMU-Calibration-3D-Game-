...
void MotionAC_manager_compensate(CUSTOM_MOTION_SENSOR_Axes_t *data_in, CUSTOM_MOTION_SENSOR_Axes_t *data_out);
int16_t acc_bias_to_mg(float acc_bias);
void MotionAC_manager_save_to_flash(MAC_output_t *calib);
#ifdef __cplusplus
}
#endif
